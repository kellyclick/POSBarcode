...
if(move_uploaded_file($f_tmp,$store )){
 ...
 $f_newfile; 
  ...
  if($update->execute()){
    ...
    $_SESSION['status']="Product is Succesfully Updated With Image";
...
<input type="number" min="1" step="any" class="form-control" value="<?php echo $purchaseprice_db;?>" placeholder="Enter stock" name="txtpurchaseprice" required>
</div>     

<div class="form-group">
<label >Sale Price</label>
<input type="number" min="1" step="any" class="form-control" value="<?php echo $saleprice_db;?>" placeholder="Enter Stock" name="txtsaleprice" required>
</div>     
...
<img src="productimage/<?php echo $image_db; ?>" class="img-rounded" width="50px" height="50px">
