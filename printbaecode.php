...
<ul class="list-group">
 ...
 <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input autocomplete="OFF" type="text" class="form-control" value="'.$row->saleprice.'"  id="stock"  name="stock" readonly>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input autocomplete="OFF" type="text" class="form-control" value="'.$row->stock.'"  id=""  name="rate" readonly>
      </div>
    </div>
